							...
							<article class="blog-post">
								...
								<div class="pt-4">
									...
									<h2 class="h4"><a class="text-black" href="{{ route('blogDetail',$article->id)}}"> {{$article->title }}</a></h2>
									 <a href="{{ route('blogDetail',$article->id)}}" class="text-primary fw-bold" aria-label="Read the full article by clicking here">Read More</a>
								</div>
							</article>
						</div>
                        @php $x++; @endphp
			...
			<div class="col-lg-3">
				...
				<div class="widget widget-categories">
					...
					<ul class="list-unstyled widget-list">
						...
						<li><a wire:navigate href="{{route('blog').'?categorySlug='.$category->slug}}">{{$category->name}} <small class="ml-auto">(1)</small></a>
						</li>			
						@endforeach
					</ul>
                    @endif
